          ...
          <Carousel.Item>
            <div className="flexcontainer ">
              <div className="flexbox">
                ...
                <div className="fbody">
                  The team at Nexwave was a pleasure to work with. Their
          ...
          <Carousel.Item>
            <div className="flexcontainer">
              <div className="flexbox">
                <div className="fheader"></div>
                <div className="fbody">
                  I just wanted to give a shoutout to the team at Nexwave for
          ...
          <Carousel.Item>
            <div className="flexcontainer">
              <div className="flexbox">
                <div className="fheader"></div>
                <div className="fbody">
                  Nexwave completely transformed our business with their careful
